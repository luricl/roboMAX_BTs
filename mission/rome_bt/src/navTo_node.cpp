#include "navTo_node.h"


navToNode::navToNode(const std::string &name,
...
BT::NodeStatus navToNode::onStart()
{
  // Make pose
  ...
  send_goal_options.result_callback = std::bind(&navToNode::nav_to_pose_callback, this, std::placeholders::_1);
...
BT::NodeStatus navToNode::onRunning()
{
  if (done_flag_){
...
void navToNode::nav_to_pose_callback(const GoalHandleNav::WrappedResult &result)
{
